...
<div class="heading" style="background:url(image/desert.jpg) no-repeat">
    <h1>Desert Adventure</h1>
</div>

<section class="details-container">
  <h1>🏜️ Desert Adventure — Cholistan, Pakistan</h1>
  <p>
    Embark on a thrilling journey through the golden sands of Cholistan Desert. Discover nomadic culture, majestic forts, and stunning desert sunsets with our Desert Adventure package.
  </p>
  ...
  <div class="highlights">
    ...
    <ul>
      <li><strong>Desert Safari:</strong>
        <ul>
          <li>Exciting off-road experience in 4x4 jeeps</li>
          <li>Golden sand dunes and breathtaking sunsets</li>
        </ul>
      </li>
      <li><strong>Historic Exploration:</strong>
        <ul>
          <li>Guided tour of the majestic Derawar Fort</li>
        </ul>
      </li>
      <li><strong>Adventure & Culture:</strong>
        <ul>
          <li>Camel rides and sandboarding thrills</li>
          <li>Evenings with traditional folk music and campfire</li>
          <li>Interact with local desert tribes and learn their way of life</li>
        </ul>
      </li>
    </ul>
    ...
    <ul>
      <li>Stay in desert camps equipped with modern facilities</li>
      <li>Experience authentic desert nights under the starlit sky</li>
    </ul>

    <h2>📦 What’s Included:</h2>
    <ul>
      <li>Pick & drop service from Bahawalpur</li>
      <li>All meals and refreshments during the trip</li>
      <li>Local guide, cultural performances, and tribal insights</li>
      <li>Camping equipment and first-aid support</li>
    </ul>

    <h2>🗓️ Duration & Best Time to Visit:</h2>
    <p><strong>Duration:</strong> 3 Days / 2 Nights</p>
    <p><span id="month">November to February</span> — Cooler temperatures make for the perfect desert adventure.</p>

    <h2>🧭 Ideal For:</h2>
    <p>Adventure seekers, cultural explorers, photographers, and those looking for a unique off-the-grid experience.</p>
  </div>

  <h2 style="margin-top: 30px;">💰 Price per Guest:</h2>
  <p>
    <span class="original-price">PKR 22,000</span> →
    <span class="discount-price">PKR 11,000 (50% Off)</span>
  </p>
